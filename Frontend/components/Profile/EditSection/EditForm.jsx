    ...
    <form className='editForm-container'>
        <div className='firstRow'>
            ...
            <div>
                ...
                <input type="text" name="name" value={name} className='editInput'/>
            </div>

            
            <div>
                <label className='editSpans' htmlFor="lastname">Last Name</label>
                <input type="text" name="lastname" value={surname} className='editInput'/>
            </div>
        ...
        <div className='midRow'>
                ...
                <input type="email" value={email} disabled name="email" className='editInput'/>
        ...
        <div className='firstRow'>
            ...
            <div>
                ...
                <input type="text" name="phone" className='editInput' value='+98 257 6985'/>
            </div>

            
            <div id="countryEdit">
                <label className='editSpans' htmlFor="country">Country</label>
                <input type="text" name="country" className='editInput' value={country}/>
            </div>
