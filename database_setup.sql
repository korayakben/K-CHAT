...
-- ADD COLUMN from_username VARCHAR(50) NOT NULL,
-- ADD COLUMN to_username VARCHAR(50) NOT NULL,
-- ADD CONSTRAINT unique_notification UNIQUE (from_username, to_username, type, title);
...
-- ADD CONSTRAINT unique_user_notification UNIQUE (user_id, notifID);
...
--     CONSTRAINT fk_from_user FOREIGN KEY (from_username) REFERENCES users(username) ON DELETE CASCADE,
--     CONSTRAINT fk_to_user FOREIGN KEY (to_username) REFERENCES users(username) ON DELETE CASCADE,
--     CONSTRAINT unique_request UNIQUE (from_username, to_username)
-- );
